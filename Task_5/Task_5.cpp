...
void FindAverageValuesParal(double** matrix, const size_t
...
int main()
{
	...
	try
	{
		...
		FindAverageValuesParal(matrix, numb_rows, numb_cols, average_vals_in_rows, average_vals_in_cols);
